...
<div style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
  ...
  <!-- Card 0 -->
  <div style="border: 1px solid var(--card-border-color, #30363d); border-radius: 10px; width: 300px; padding: 15px; text-align: center; background: var(--card-bg, transparent); box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
  ...
  <!-- Card 5 -->
  <div style="border: 1px solid var(--card-border-color, #30363d); border-radius: 10px; width: 300px; padding: 15px; text-align: center; background: var(--card-bg, transparent); box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
    <img src="/assets/img/certificates/Cyber Specialist.jpg" alt="Cybersecurity Specialist" style="width: 100%; border-radius: 5px;">
    <h3 style="margin-top: 10px;">Cybersecurity Specialist</h3>
    <p>October 2024</p>
  ...
  <!-- Card 9 -->
  <div style="border: 1px solid var(--card-border-color, #30363d); border-radius: 10px; width: 300px; padding: 15px; text-align: center; background: var(--card-bg, transparent); box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
    <img src="/assets/img/certificates/Try1.jpg" alt="Pre Security Learning Path" style="width: 100%; border-radius: 5px;">
    <h3 style="margin-top: 10px;">Pre Security</h3>
    <p>December 2024</p>
  </div>
